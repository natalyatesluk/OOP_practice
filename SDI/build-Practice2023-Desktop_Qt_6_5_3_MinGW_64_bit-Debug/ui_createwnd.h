...
public:
    ...
    void setupUi(QWidget *CreateWnd)
    {
        ...
        gridLayout->addWidget(lineEdit_gener, 0, 3, 1, 1);
        ...
        gridLayout->addWidget(lineEdit_writer, 1, 3, 1, 1);
        ...
        gridLayout->addWidget(lineEdit_lng, 2, 3, 1, 1);
        ...
        gridLayout->addWidget(lineEdit_time, 3, 3, 1, 1);
        ...
        gridLayout->addWidget(Button_song, 4, 2, 1, 2);
    ...
    {
        CreateWnd->setWindowTitle(QCoreApplication::translate("CreateWnd", "Form", nullptr));
